...
[Link to documentation](https://docs.procesio.com/inbound-email)

****

**The&#x20;*****JSON&#x20;*****folder contains actions that can be used while working with JSON inputs.**

1. [Json Mapper](https://docs.procesio.com/json-mapper) - JSON Mapper enables you to extract a value from a JSON or a JSON array.
2. [Json Mapper To List](https://docs.procesio.com/json-mapper-to-list) - JSON Mapper enables you to extract a list of values from a JSON or a JSON array.
3. [Read JSON file](https://docs.procesio.com/read-json-file)
...
[Link to documentation](https://docs.procesio.com/documents)
...
[Link to documentation](https://docs.procesio.com/xpath)
...
[Link to documentation](https://docs.procesio.com/javascript)
...
[Link to documentation](https://docs.procesio.com/pdf-extract-text)
...
[Link to documentation](https://docs.procesio.com/ftpsftp-actions)
...
[Link to documentation](https://docs.procesio.com/generate-guid)
...
[Link to documentation](https://docs.procesio.com/webhooks-or-incoming)
...
[Link to documentation](https://docs.procesio.com/document-designer)
