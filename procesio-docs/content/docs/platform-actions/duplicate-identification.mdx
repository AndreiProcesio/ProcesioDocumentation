...
**&#x20;  Step 3.   &#x20;**&#x57;e will use in our example the **employeelist** [data model](https://docs.procesio.com/working-with-data-models).
...
- **MatchType&#x20;**- pattern matching is made by using several algorithms, the values accepted (you can use several in a combined manner) are:
  ...
  - **Fuzzy&#x20;**- this uses the algorithms available in StringSimilarity Action to compare one string against the other (read this for more details: [Actions | String similarity](https://docs.procesio.com/string-similarity) ).
