...
### How to[﻿](https://kb.procesio.com/regex-replace#qd-how-to)﻿

&#x20; 1\.    [Create a new process](https://docs.procesio.com/creating-a-basic-process) and give it a name.
...
&#x20; 3\.    [Add the needed variables](https://docs.procesio.com/working-with-process-variables).

![](/images/docs/3-mR2l3PRJjqdm2f1OqXi_image.png)

- ****&lt;%input%&gt; will contain the JSon data, the default will use
...
- ****&lt;%filter%&gt; will contain the JQuerry expression that we will use on our data. In this exaplte the &lt;%filter%&gt; will be `..name`
