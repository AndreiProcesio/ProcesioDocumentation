...
**&#x20;   Step 1.    Create the&#x20;**[data model](https://docs.procesio.com/working-with-data-models) CompanyDetails who uses the data model Compan&#x79;**.**

*(Screenshot unavailable — image was removed from the original source.)*

*(Screenshot unavailable — image was removed from the original source.)*

**&#x20;   Step 2.   &#x20;**[Create a new process](https://docs.procesio.com/creating-a-basic-process) and give it a name.

&#x20;**&#x20;  Step 3.   &#x20;**&#x44;rag the **Sort data model** action to the canvas and link it to the other actions.

*(Screenshot unavailable — image was removed from the original source.)*

&#x20;**&#x20;  Step 4.   &#x20;**&#x43;reate the [variable](https://docs.procesio.com/working-with-process-variables) we will use to hold the input data, for simplicity we will provide a default value to it.
