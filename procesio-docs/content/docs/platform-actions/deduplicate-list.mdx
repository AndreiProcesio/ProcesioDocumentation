...
**&#x20;  Step 3.   &#x20;**[Add the needed variables](https://docs.procesio.com/working-with-process-variables).
...
- **Fuzzy&#x20;**- this uses the algorithms available in the **StringSimilarity** Action to compare one string against the other (read this for more details: [Actions | String similarity](https://docs.procesio.com/string-similarity) ).
