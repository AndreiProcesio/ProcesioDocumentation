...
- When working with data representing an entire population (full population data), opt for the [List Standard Deviation](https://docs.procesio.com/how-to/list-standard-deviation) action to accurately measure the variability. However, if you are dealing with a sample from a larger population, do NOT use the List Standard Deviation action.
