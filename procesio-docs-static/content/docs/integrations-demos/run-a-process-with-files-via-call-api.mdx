...
**Step 3:** In the Automation section - API keys - create a new key  [https://docs.procesio.com/api-keys](https://docs.procesio.com/api-keys) .
...
[📎 RunAnotherProcess.procesio](/files/7NvvpDWSQowYItyWEp7m1_runanotherprocess.procesio)
</Callout>
