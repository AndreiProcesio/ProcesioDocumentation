...
To begin, create and sign in to your accounts on [Procesio](https://procesio.com/), [Airtable](https://airtable.com/) and [﻿](https://www.typeform.com/)﻿[Typeform](https://www.typeform.com/).

## ****[Typeform](https://docs.procesio.com/integrations/typeform)****
...
## ****[Airtable](https://docs.procesio.com/integrations/airtable)****
...
&#x20; 4\.    Create the process [process variables](https://docs.procesio.com/working-with-process-variables):

- ****&lt;%Typeform%&gt; - the input variable generated when we add the webhook to store the Typeform data.
- &#x20;&lt;%department%&gt;, &lt;%name%&gt;, &lt;%punctual%&gt;, &lt;%email%&gt;, &lt;%rating%&gt;**&#x20;-&#x20;**&#x74;he variables that will store the form inputs in Procesio.
- ****&lt;%status%&gt;, &lt;%body%&gt; - the helper variables that will help us diagnose the Airtable API Call in case of an error.&#x20;
