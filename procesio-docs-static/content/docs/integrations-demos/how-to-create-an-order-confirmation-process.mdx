...
- the above requires the creation of 2 connection configurations in the [Credentials Manager](https://docs.procesio.com/working-with-credentials).
...
For this demo we have created a connection to a Gmail server, check the [GMail documentation](https://docs.procesio.com/integrations).

<Callout type="info">
You can also create and use a connection to any email server (check [Yahoo](https://docs.procesio.com/integrations/yahoo) or [SendGrid](https://docs.procesio.com/integrations/sendgrid) connection documentation).
</Callout>
...
- **to**: &lt;% variable
- **body**: &lt;%, your order *orderId* (variable)has been confirmed. Thank you for your purchase!
