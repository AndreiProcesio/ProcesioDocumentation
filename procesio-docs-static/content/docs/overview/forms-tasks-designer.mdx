...
- [Create a form](https://docs.procesio.com/create-form)&#x20;
- [Task assignees and Approvals](https://docs.procesio.com/task-assignees-and-approvals)&#x20;
- [Submissions](https://docs.procesio.com/submissions)
- [Assigned to me ](https://docs.procesio.com/assigned-to-me)
- [Events and Process Triggers ](https://docs.procesio.com/events-and-process-triggers)
