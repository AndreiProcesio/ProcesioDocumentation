...
Utilizes algorithms from **Similarity Search** to compare fields against `FilterExpression`. More details [here](https://docs.procesio.com/how-to/similarity-search).
...
- `FuzzyAlgorithm` needs to be one from this [here](https://docs.procesio.com/how-to/similarity-search), written exactly as in the link provided.
