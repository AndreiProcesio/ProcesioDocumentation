...
First of all, you'll have to enter credentials for the **Execute Query** action. You can find out how to do that [here](https://docs.procesio.com/sql-credential).&#x20;
...
**Step 3:&#x20;**&#x53;elect a credential [(see here how to create one)](https://docs.procesio.com/sql-credential)
